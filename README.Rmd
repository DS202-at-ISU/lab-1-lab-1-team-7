...
1. From RStudio make changes to the README.md file by adding “This is a line from RStudio”.
...
5. add a message to the commit message such as "Commit message from RStudio".
5. Click commit.
